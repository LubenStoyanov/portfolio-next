...
export default function Contact() {
  return (
    <section
      id="contact"
      className="flex flex-col sm:items-center mt-10 sm:mt-20"
    >
      <h2 className="font-bold sm:text-[4vw] text-center">&lt;CONTACT /&gt;</h2>
      <p className="mt-5 sm:text-[3vw] max-w-[40ch]">
